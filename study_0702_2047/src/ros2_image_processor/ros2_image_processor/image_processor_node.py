...
class ImageProcessorNode(Node):
    def __init__(self):
        ...
        # self.enable_segmentation = True  # Enable/disable segmentation (temporarily disabled)
        # self.segformer_inference = None
        # if self.enable_segmentation:
        #     try:
        #         self.segformer_inference = SegformerInference()
        #         self.get_logger().info('SegformerInference initialized successfully')
        #     except Exception as e:
        #         self.get_logger().warn(f'Failed to initialize SegformerInference: {e}')
    ...
    def process_and_publish(self):
        ...
        # print('here')
        # if self.enable_segmentation and self.segformer_inference is not None:
        #     try:
        #         segmentation_map = self.segformer_inference.segment(stitched_image)
        #         final_image = self.segformer_inference.overlay_segmentation(stitched_image, segmentation_map)
