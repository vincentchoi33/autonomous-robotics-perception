...
# Step 0: Build Docker image with CUDA support
echo "Step 0: Building Docker image with CUDA support..."
...
# Step 1: Start Docker container with GPU support
echo "Step 1: Starting Docker container with GPU support..."
